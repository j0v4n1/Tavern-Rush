...
namespace Tavern_Rush
{
    ...
    internal class Perk
    {
        private Dictionary<PerkType, string> _perksNames = new Dictionary<PerkType, string>()
        {
        ...
        private Dictionary<PerkType, string> _perksDescribe = new Dictionary<PerkType, string>()
        {
        ...
        public void ShowAllPerks()
        {
            ...
            int dictionaryLength = _perksNames.Count;
            int i = 1;
            foreach (var item in _perksNames)
            {
